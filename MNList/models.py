...
class BBrgy(models.Model):
      mmunicipality = models.TextField(default='')  
      bname = models.TextField(default='')  
...
class BResidents(models.Model):     
      ...
      rstat = models.TextField(default='')
      radd = models.TextField(default='')    
      bbrgy = models.ForeignKey(BBrgy, default=None, on_delete=models.CASCADE)
      class meta
          db = "residents"	
